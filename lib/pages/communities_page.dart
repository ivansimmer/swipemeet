...
if (usersRaw is List) {
  for (var u in usersRaw) {
    if (u is String) {
      users.add(u);
    } else if (u is Map && u['uid'] is String) {
      users.add(u['uid']);
    }
  }
}
                            ...
                            if (msg is Map) {
                              ...
                              lastMessage = '$senderName: $text$time';
                            ...
                            if (type == 'escuela') {
                              ...
                              if (logoFile.isNotEmpty) {
                                ...
                                iconColor =
                                    universityColors[name] ?? Colors.grey;
                                avatar = CircleAvatar(
                            ...
                            return Padding(
                              ...
                              child: Center(
                                child: ElevatedButton.icon(
                                  onPressed: () =>
                                      context.push('/discover_communities'),
